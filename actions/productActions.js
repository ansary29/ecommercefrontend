...
export const updateProduct = (product) => async (dispatch, getState) => {
  try {
    ...
    console.log(product, 'COOLLLLLLL')
...
// export const getProductsByCategories = (categoryId) => async (dispatch) => {
//   try {
//     dispatch({type: PRODUCT_LIST_CATEGORIES})
//   } catch (error) {
